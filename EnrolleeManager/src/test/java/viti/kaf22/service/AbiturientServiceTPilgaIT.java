...
public class AbiturientServiceTPilgaIT {
	...
	final static Logger logger = Logger.getLogger(AbiturientServiceTPilgaIT.class);
	...
	public void a_testSaveWithSpecialnist() {
		...
		assertTrue(abiturient2.getPilgis().stream().findFirst().get().getTip_pilgi().equals(TipPilgi.None));
		logger.debug(abiturient2.getPilgis().stream().findFirst().get().getPilgaTipName());
		...
		assertTrue(abiturient3.getPilgis().stream().findFirst().get().getTip_pilgi().equals(TipPilgi.PozaCherg));
		logger.debug(abiturient3.getPilgis().stream().findFirst().get().getPilgaTipName());
		
		aService.delete(abiturient);
		assertTrue(true);
		Abiturient abiturient4 = aService.getWithLazy(abiturient.getId());
		assertNull(abiturient4);
